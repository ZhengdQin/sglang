...
class W8A8Int8Config(QuantizationConfig):
    ...
    def __init__(self, quant_config: Dict[str, Any] = {}):
        ...
        if target_scheme is None:
            ...
            self.is_moe_w4a8_dynamic = self.is_dynamic_token_w4a8(
    ...
    def get_quant_method(
        ...
        if _is_npu:
            if isinstance(layer, LinearBase):
                ...
                if self.is_moe_w4a8_dynamic or is_moe_w4a8_dynamic:
    ...
    def is_dynamic_token_w4a8(self, weight_quant, input_quant) -> bool:
